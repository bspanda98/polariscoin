...
This mechanism has been integrated into Bitcore-Node-polariscoinnetwork which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/polariscoinnetwork/insight-api-polariscoinnetwork#web-socket-api](https://github.com/polariscoinnetwork/insight-api-polariscoinnetwork#web-socket-api)
* API: [https://github.com/polariscoinnetwork/insight-api-polariscoinnetwork#swifttx-transactions](https://github.com/polariscoinnetwork/insight-api-polariscoinnetwork#swifttx-transactions)
...
By default, the polariscoinnetwork Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the polariscoinnetwork Core daemon:
