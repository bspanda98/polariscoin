polariscoinnetwork Core
=====================

Intro
-----
polariscoinnetwork (POL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. polariscoinnetwork utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run polariscoinnetwork-qt.exe.

polariscoinnetwork Core is the original polariscoinnetwork client and it builds the backbone of the network.
However, it downloads and stores the entire history of polariscoinnetwork transactions;
