...
polariscoinnetwork now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<polariscoinnetwork_address\> \<monthly_payment_polariscoinnetwork\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<polariscoinnetwork_address\> \<monthly_payment_polariscoinnetwork\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a polariscoinnetwork initiative
 * vote-alias         - Vote on a polariscoinnetwork initiative
 * vote               - Vote on a polariscoinnetwork initiative/budget
