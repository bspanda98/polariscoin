...
In order to support loading of multiple wallets in polariscoinnetwork-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is polariscoinnetwork.cpp.
...
Changes to polariscoinnetwork.cpp
----------------------
polariscoinnetwork.cpp is the entry point into polariscoinnetwork-qt, and as such, will require some minor modifications to provide hooks for
