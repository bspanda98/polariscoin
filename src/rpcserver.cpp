...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop polariscoinnetwork server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "polariscoinnetwork server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* polariscoinnetwork features */
        {"polariscoinnetwork", "masternode", &masternode, true, true, false},
        {"polariscoinnetwork", "listmasternodes", &listmasternodes, true, true, false},
        {"polariscoinnetwork", "getmasternodecount", &getmasternodecount, true, true, false},
        {"polariscoinnetwork", "masternodeconnect", &masternodeconnect, true, true, false},
        {"polariscoinnetwork", "masternodecurrent", &masternodecurrent, true, true, false},
        {"polariscoinnetwork", "masternodedebug", &masternodedebug, true, true, false},
        {"polariscoinnetwork", "startmasternode", &startmasternode, true, true, false},
        {"polariscoinnetwork", "createmasternodekey", &createmasternodekey, true, true, false},
        {"polariscoinnetwork", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"polariscoinnetwork", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"polariscoinnetwork", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"polariscoinnetwork", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"polariscoinnetwork", "getmasternodescores", &getmasternodescores, true, true, false},
        {"polariscoinnetwork", "mnbudget", &mnbudget, true, true, false},
        {"polariscoinnetwork", "preparebudget", &preparebudget, true, true, false},
        {"polariscoinnetwork", "submitbudget", &submitbudget, true, true, false},
        {"polariscoinnetwork", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"polariscoinnetwork", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"polariscoinnetwork", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"polariscoinnetwork", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"polariscoinnetwork", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"polariscoinnetwork", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"polariscoinnetwork", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"polariscoinnetwork", "checkbudgets", &checkbudgets, true, true, false},
        {"polariscoinnetwork", "mnsync", &mnsync, true, true, false},
        {"polariscoinnetwork", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> polariscoinnetwork-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1948/\n";
}
