...
// Copyright (c) 2019 The polariscoinnetwork developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1589711910, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // polariscoinnetwork: 2 minute blocks during POW (block 1-200)
        ...
        const char* pszTimestamp = "polariscoinnetwork is live - corona spread 30/08/2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1589711910;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22584307;
        ...
        assert(hashGenesisBlock == uint256("0x0000037724244734b295da05e8b3b17dd2154674134764ad4d5d7960d9808474"));
        assert(genesis.hashMerkleRoot == uint256("0xe3d155e08ece68943d53c45c8d6ff0d493a3f7c11a1688d3244f0562d8a539c0"));

        // polariscoinnetwork addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 55);
        // polariscoinnetwork script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // polariscoinnetwork private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // polariscoinnetwork BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // polariscoinnetwork BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // polariscoinnetwork BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // polariscoinnetwork: 1 day
        nTargetSpacing = 2 * 60;  // polariscoinnetwork: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet polariscoinnetwork addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet polariscoinnetwork script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet polariscoinnetwork BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet polariscoinnetwork BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet polariscoinnetwork BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // polariscoinnetwork: 1 day
        nTargetSpacing = 2 * 60;        // polariscoinnetwork: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
