/* src/config/polariscoinnetwork-config.h.  Generated from polariscoinnetwork-config.h.in by configure.  */
/* src/config/polariscoinnetwork-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "polariscoinnetwork Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "polariscoinnetwork Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "polariscoinnetwork"
