...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("polariscoinnetwork Core polariscoinnetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  polariscoinnetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded polariscoinnetwork transaction") + "\n" +
                               "  polariscoinnetwork-tx [options] -create [commands]   " + _("Create hex-encoded polariscoinnetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded polariscoinnetwork transaction
