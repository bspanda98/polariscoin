...
#define URI_SCHEME "polariscoinnetwork"
...
{
    // return if URI is not valid or is no polariscoinnetwork: URI
...
{
    // Convert polariscoinnetwork:// to polariscoinnetwork:
    //
    //    Cannot handle this later, because polariscoinnetwork:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open polariscoinnetwork.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "polariscoinnetwork.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for polariscoinnetwork.lnk
...
{
    return GetAutostartDir() / "polariscoinnetwork.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a polariscoinnetwork.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=polariscoinnetwork\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the polariscoinnetwork app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add polariscoinnetwork app to startup item list
