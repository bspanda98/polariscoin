...
/** Utility functions used by the polariscoinnetwork Qt UI.
 */
namespace GUIUtil
{
...
// Parse "polariscoinnetwork:" URI into recipient object, return true on successful parsing
