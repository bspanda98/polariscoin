...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("polariscoinnetwork Core"),
     ...
     * override -datadir in the polariscoinnetwork.conf file in the default data directory
     * (to be consistent with polariscoinnetworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
