...
// Copyright (c) 2017-2018 The polariscoinnetwork Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("polariscoinnetwork Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and polariscoinnetwork: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About polariscoinnetwork Core"), this);
    aboutAction->setStatusTip(tr("Show information about polariscoinnetwork Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for polariscoinnetwork Core"));
    ...
    openAction->setStatusTip(tr("Open a polariscoinnetwork: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the polariscoinnetwork Coin help message to get a list with possible polariscoinnetwork Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/polariscoinnetwork_logo_horizontal").pixmap(210, 50));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("polariscoinnetwork Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to polariscoinnetwork network", "", count));
}
...
{
    QString strTitle = tr("polariscoinnetwork Core"); // default title
    ...
    // Append title to "polariscoinnetwork Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
