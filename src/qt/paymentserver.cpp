...
const QString BITCOIN_IPC_PREFIX("polariscoinnetwork:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/polariscoinnetwork-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/polariscoinnetwork-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/polariscoinnetwork-paymentrequest";
...
{
    QString name("polariscoinnetworkQt");
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++) {
        ...
        // If the polariscoinnetwork: URI contains a payment request, we are not able to detect the
        // network as that would require fetching and parsing the payment request.
        // That means clicking such an URI which contains a testnet payment request
        // will start a mainnet instance and throw a "wrong network" error.
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // polariscoinnetwork: URI
        {
                                                                       ...
                                                                       optionsModel(0)
{
    ...
    // on Mac: sent when you click polariscoinnetwork: links
    ...
    if (startLocalServer) {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start polariscoinnetwork: click-to-pay handler"));
        } else {
...
//
// OSX-specific way of handling polariscoinnetwork: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject* object, QEvent* event)
{
    // clicking on polariscoinnetwork: URIs creates FileOpen events on the Mac
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in polariscoinnetwork: URIs
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // polariscoinnetwork: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
